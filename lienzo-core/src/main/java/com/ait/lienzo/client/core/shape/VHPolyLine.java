 ...
 */
public class VHPolyLine extends AbstractDirectionalMultiPointShape<VHPolyLine> {
    ...
    private Point2DArray actualPoints = new Point2DArray();
    ...
    public VHPolyLine(final Point2DArray points) {
        super(ShapeType.POLYLINE);
    ...
    @Override
    public VHPolyLine refresh() {
        super.refresh();

        return this;
    }

    public VHPolyLine(final Point2DArray points, final double corner) {
        this(points);
        setCornerRadius(corner);
    }

    public VHPolyLine(final Point2D... points) {
        this(Point2DArray.fromArrayOfPoint2D(points));
    }

    public VHPolyLine(double... array) {
    ...
    public boolean parse() {
        DomGlobal.console.error("PARSING");
        ...
        this.actualPoints = getPoints().copy();
    ...
    public VHPolyLine setCornerRadius(final double radius) {
    ...
    @Override
    public VHPolyLine setPoint2DArray(Point2DArray points) {
    ...
    @Override
    public Shape<VHPolyLine> copyTo(Shape<VHPolyLine> other) {
        super.copyTo(other);
        ((VHPolyLine) other).m_headOffsetPoint = m_headOffsetPoint.copy();
        ((VHPolyLine) other).m_tailOffsetPoint = m_tailOffsetPoint.copy();
        ((VHPolyLine) other).cornerRadius = cornerRadius;

        return other;
    }

    @Override
    public VHPolyLine cloneLine() {
        VHPolyLine polyLine = new VHPolyLine(this.getControlPoints().copy(), cornerRadius);
        return (VHPolyLine) copyTo(polyLine);
    }
}
