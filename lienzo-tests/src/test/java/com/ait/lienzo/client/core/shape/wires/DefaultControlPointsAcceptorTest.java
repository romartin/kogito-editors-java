...
public class DefaultControlPointsAcceptorTest {
    ...
    public void testAdd() {
        ...
        // TODO verify(connector, never()).moveControlPoint(anyInt(), any(Point2D.class));
    }

    @Test
    public void testMove() {
        Point2DArray points = Point2DArray.fromArrayOfDouble(0d, 1d);
        // TODO boolean result = tested.move(connector, points);
        // TODO assertTrue(result);
        // TODO verify(connector, times(1)).moveControlPoint(eq(0), eq(new Point2D(0d, 1d)));
