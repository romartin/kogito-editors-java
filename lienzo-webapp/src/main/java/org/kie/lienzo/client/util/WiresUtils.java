...
public class WiresUtils {
    ...
    public static WiresConnector connect(MagnetManager.Magnets magnets0,
        ...
        if (orthogonalPolyline) {
            ...
            line = createOrthogonalNewPolyline(x0, y0, x1, y1);
    ...
    public static OrthogonalNewPolyLine createOrthogonalNewPolyline(final double... points) {
        return createOrthogonalNewPolyline(Point2DArray.fromArrayOfDouble(points));
    }

    public static OrthogonalNewPolyLine createOrthogonalNewPolyline(final Point2DArray points) {
        return new OrthogonalNewPolyLine(points).setCornerRadius(5).setDraggable(true);
    }
